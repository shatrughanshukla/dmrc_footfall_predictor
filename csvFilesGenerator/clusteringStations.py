...
#     line_stations = stations_df[stations_df['Line'] == line].reset_index(drop=True)
    
#     # Pair consecutive stations
#     for i in range(len(line_stations) - 1):
#         start_station = line_stations.iloc[i]
#         end_station = line_stations.iloc[i + 1]
...
#                 })
#                 travel_times.append({
#                     "Start Station": end_station['Station'],
#                     "End Station": start_station['Station'],
#                     "Line": line,
#                     "Travel Time (minutes)": travel_time
#                 })
#             else:
...
# output_file = 'dmrc_travel_times.csv'
